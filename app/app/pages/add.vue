    ...
    <form v-else @submit.prevent="submitForm" class="space-y-6">
      ...
      <div class="space-y-2">
        <div class="flex items-center justify-between">
          ...
          <span class="text-[9px] font-bold" :class="store.isDarkMode.value ? 'text-white/40' : 'text-black/30'">
          ...
          <div v-if="form.images.length > 0" class="w-full flex gap-4 overflow-x-auto snap-x snap-mandatory pb-4 scrollbar-thin">
            ...
            >
              ...
              <button 
                ...
                class="absolute top-2 right-2 p-1.5 border transition-all duration-300 rounded-none bg-black/80 border-none   text-white shadow-lg"
              >
