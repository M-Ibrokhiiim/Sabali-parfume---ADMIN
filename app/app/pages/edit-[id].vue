          ...
          <div v-if="form.images.length > 0" class="w-full flex gap-4 overflow-x-auto snap-x snap-mandatory pb-4 scrollbar-thin">
            ...
            >
              ...
              <button 
                ...
                class="absolute top-2 right-2 p-1.5 border transition-all duration-300 rounded-none bg-red-600/90 hover:bg-red-500 border-red-500 text-white shadow-lg opacity-0 group-hover:opacity-100"
              >
